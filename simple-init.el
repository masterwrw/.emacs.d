...
(defun my-c-hook ()
  ...
  (c-add-style "Custom Style" my-c-style t)
...
;;(add-to-list 'default-frame-alist '(font . "Source Code Pro-11.5"))
;;(set-face-attribute 'default t :font "Source Code Pro-11.5")
