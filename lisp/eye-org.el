...
(require 'org)
;; 9.3使用<s需要org-tempo
(when (>= emacs-major-version 27) (require 'org-tempo))
(require 'htmlize)
...
(setq org-agenda-files (directory-files (concat locale-notebook-dir "/org/priv") t "^proj-*"))

(add-to-list 'org-agenda-files (concat locale-notebook-dir "/org/priv/goals.org"))
(add-to-list 'org-agenda-files (concat locale-notebook-dir "/org/priv/inbox.org"))
(add-to-list 'org-agenda-files (concat locale-notebook-dir "/org/priv/someday.org"))
(add-to-list 'org-agenda-files (concat locale-notebook-dir "/org/priv/tickler.org"))
