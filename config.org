...
(setq org-capture-templates
      '(
	("n" "New" entry
	 (file (concat eye/org-agenda-directory "inbox.org"))
         "* %?\n%i\n" :prepend t :empty-lines 1)
	
	("t" "Task" entry
	 (file+headline (concat eye/org-agenda-directory "task.org") "Tasks")
         "* %?\n%i\n")
        ))

(setq org-refile-targets
      '(
	((concat eye/org-agenda-directory "inbox.org") :level . 1)
        ((concat eye/org-agenda-directory "task.org") :level . 1)
        ((concat eye/org-agenda-directory "finished.org") :level . 1)
        ((concat eye/org-agenda-directory "trash.org") :level . 1)
	))
