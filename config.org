...
(setq org-capture-templates
      '(
	("k"
	 "New" entry (file+headline "~/notebook/gtd/inbox.org" "Inbox")
         "* %?\n%i\n"
	 :create t)
	
	("d"
	 "Task" entry (file+headline "~/notebook/gtd/task.org" "Tasks")
         "* TODO %?\n%i\n"
	 :create t)

	("f"
	 "Project" entry (file+headline "~/notebook/gtd/task.org" "Projects")
         "* TODO %?\n%i\n"
	 :create t)
	...
	("p" 
	 "Protocol" entry (file+headline "~/notebook/gtd/inbox.org" "Inbox")
	 "* [[%:link][%(transform-square-brackets-to-round-ones \"%:description\")]] \
		%^G\n:PROPERTIES:\n:Created: %U\n:END:\n\n%i\n%?"
	 :create t)
		
	("L" 
	 "Protocol link" entry (file+headline "~/notebook/gtd/inbox.org" "Urls")
         "* [[%:link][%:description]]\n%?\n"
	 :create t)
