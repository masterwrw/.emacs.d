...
;; M-x grep
(set-variable 'grep-command "grep --color -irHn \"str\" *.h")
(when *is-windows*
    (setq grep-use-null-device t)
    (set-variable 'grep-command "findstr -s -n -i -l searchstr *.h"))

(defun my-grep ()
  (interactive)
  (let* (
		 (cur-word (thing-at-point 'word))
		 (cmd (concat "findstr -s -n -i -l " cur-word " *.h"))
		 )
	(read-from-minibuffer "command:" cmd)
...
(global-set-key '[(C-f1)] 'bookmark-save)
(global-set-key '[(S-f1)] 'bookmark-set)
...
(defun my-dark-theme ()
  ...
  ;; list-faces-display show all faces variable
  (set-face-attribute 'font-lock-builtin-face nil :foreground "#999999")
  (set-face-attribute 'font-lock-comment-face nil :foreground "gray50")
  (set-face-attribute 'font-lock-constant-face nil :foreground "olive drab")
  (set-face-attribute 'font-lock-doc-face nil :foreground "gray50")
  (set-face-attribute 'font-lock-function-name-face nil :foreground "#00f000" :underline t)
  (set-face-attribute 'font-lock-keyword-face nil :foreground "DarkGoldenrod3")
  (set-face-attribute 'font-lock-string-face nil :foreground "olive drab")
  (set-face-attribute 'font-lock-type-face nil :foreground "burlywood3")
  (set-face-attribute 'font-lock-variable-name-face nil :foreground "#900000")
  (set-face-attribute 'font-lock-note-face nil :foreground "000090")

  (set-face-attribute 'company-tooltip-selection nil :foreground "black")

  (set-face-attribute 'ivy-minibuffer-match-face-1 nil :foreground "black")
  (set-face-attribute 'ivy-minibuffer-match-face-2 nil :foreground "black")
  (set-face-attribute 'ivy-minibuffer-match-face-3 nil :foreground "black")
  (set-face-attribute 'ivy-minibuffer-match-face-4 nil :foreground "black")

  ;; M-x faces
  (set-face-attribute 'ido-vertical-first-match-face nil :background "black" :foreground "red")
  (set-face-attribute 'ido-vertical-only-match-face nil :background "#e52b50" :foreground "white")
